...
import { Sparkles, LayoutDashboard, FolderTree, Plus, Languages, LogOut, Palette, Check, BookMarked, Mic, GraduationCap } from "lucide-react";
...
const navItems = [
  ...
  { to: "/oral-analysis", label: "Coach oral", icon: Mic },
  { to: "/grades", label: "Mes notes", icon: GraduationCap },
